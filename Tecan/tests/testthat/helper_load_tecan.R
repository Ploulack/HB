...
ms_examples <- list(
     ...
     "replicates" = list(xml = read_xml("tests/testthat/ms_xml_files/quandata_UNITARY_2018_05_01_HB219_growth24_induced_96.xml"),
                         desc = "single plate with plenty of duplicates")
) %>%
